Univision Project
A 3D experience that brings a scanned model of our university campus into an interactive application built on Unity. By scanning a QR code, users can align the virtual campus model with their real-world position, enabling them to explore and navigate the campus in augmented reality.

Features
3D Campus Model

Manually scanned 3D model of the entire campus.
...
Built to run on various devices (iOS, Android, tablets) with minimal configuration.
Ensures consistent AR experiences across different screen sizes and hardware.
